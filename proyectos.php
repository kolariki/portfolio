            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto">
                    <div class="col-12 p-0">
                        ...
                        <h2> AMB CLIENTES</h2>
                        <p class="py-2 px-3"> Alta, baja y modificación de un registro de clientes. Realizado en HTML, CSS, PHP, Bootstrap
                            y Json.</p>
                    </div>
                    ...
                    <div class="col-6 py-3">
                        <a href="#" class="link-rojo text-center">Codigo Fuente</a>
                    </div>
                </div>
            </div>
